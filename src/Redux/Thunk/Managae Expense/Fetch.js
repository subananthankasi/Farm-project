...
import { MANAGE_CREATE_URL, MANAGE_FETCH_URL } from "../../Environment/Environment";


const API_URL = MANAGE_FETCH_URL

export const manageFetchThunk = createAsyncThunk('manageFetchThunk/data',
