...
import { DISTRICT_FETCH_DISTRICT } from "../../../Environment/Environment";


const API_URL = DISTRICT_FETCH_DISTRICT

export const districtFetchThunk = createAsyncThunk('districtFetchThunk/data',
