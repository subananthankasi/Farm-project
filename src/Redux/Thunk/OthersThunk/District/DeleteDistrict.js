...
import { DISTRICT_DELETE_URL } from "../../../Environment/Environment";


const API_URL = DISTRICT_DELETE_URL

export const districtDeleteThunk = createAsyncThunk('districtDeleteThunk/data',
