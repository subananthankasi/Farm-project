...
import { DISTRICT_UPDATE_URL } from "../../../Environment/Environment";


const API_URL = DISTRICT_UPDATE_URL

export const districtUpdateThunk = createAsyncThunk('districtUpdateThunk/data',
